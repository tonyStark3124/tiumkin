...
export const TermsOfUse: React.FC = () => {
  ...
  const handleAgree = () => {
    setAgreed(true);
    // כאן אפשר להפנות לדף הבית או למערכת לאחר הסכמה
    navigate('/'); 
  };
  ...
  return (
    <main
      ...
      role="main"
    >
      <h1 id="terms-title" style={titleStyle}>תנאי שימוש באתר</h1>
      ...
      <section style={sectionStyle}>
        ...
        <p>
          האתר בבעלות <strong>בוסר המלאכים</strong>. כל שימוש באתר מהווה הסכמה לתנאי שימוש אלו בלבד.
        </p>
      ...
      <button
        ...
        aria-label="אני מסכים לתנאי השימוש"
      >
        {agreed ? "תודה, הסכמת לתנאי השימוש" : "אני מסכים לתנאי השימוש"}
      </button>
    </main>
  );
};
